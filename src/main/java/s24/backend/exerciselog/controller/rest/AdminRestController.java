...
import s24.backend.exerciselog.exception.ApiNotInUseException;
...
public class AdminRestController {
    ...
    public ResponseEntity<List<UserProfileDto>> getAllUsers() {
        throw new ApiNotInUseException("This API endpoint is not available");
        /*
    ...
    public ResponseEntity<?> editUserRole(@PathVariable Long id, @RequestBody RoleDto roleDto)
