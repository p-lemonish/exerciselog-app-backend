...
public class ExerciselogApplication {
    ...
    static {
        /*
         * Get SECRET_KEY for Jwts (and other variables) from a secure, .gitignored
         * .env-file
         * 
    ...
    public CommandLineRunner initData(RoleRepository roleRepository, UserRepository userRepository,
        ...
        return (args) -> {
            ...
            /*
             * Don't initialize any other role except USER in a fresh DB
    ...
    /*
     * These migrateData functions were used for hashing all sensitive info in the
     * DB retroactively. It should no longer be used.
     */
    @Bean
